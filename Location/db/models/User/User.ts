...
import Country, {Country__Output} from "../Location/Country";
...
class User extends Model<User__Attributes, User__Input> implements User__Attributes {
    ...
    // CreatedCountries
    declare getCreatedCountries: HasManyGetAssociationsMixin<Country>; // Note the null assertions!
    declare countCreatedCountries: HasManyGetAssociationsMixin<Country>; // Note the null assertions!
    declare addCreatedCountry: HasManyAddAssociationMixin<Country, Country["CreatorId"]>;       // Notification check not required
    declare addCreatedCountries: HasManyAddAssociationsMixin<Country, Country["CreatorId"]>;     // Notification check not required
    declare removeCreatedCountry: HasManyRemoveAssociationMixin<Country, Country["CreatorId"]>; // Notification check not required
    declare removeCreatedCountries: HasManyRemoveAssociationsMixin<Country, Country["CreatorId"]>;   // Notification check not required
    declare setCreatedCountries: HasManySetAssociationsMixin<Country, Country["CreatorId"]>; // Notification check not required
