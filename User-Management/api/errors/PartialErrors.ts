...
/*      Role      */
type Partials_RelateAssociation_NotExist_Role = {
    item: "Role"
    association: "Permission"|"User"
    //association: keyof Pick<Role__Input, "permissions"|"users">
}
...
type Partials_RelateAssociation_notExist = {
    ...
    |Partials_RelateAssociation_NotExist_Role
    )
...
type Partials_RelateAssociations_notExist = {
    ...
    Partials_RelateAssociation_NotExist_User|Partials_RelateAssociation_NotExist_Role
    )
